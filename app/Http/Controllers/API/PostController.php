...
use App\API\DataManipulation\EntityCreation;
...
class PostController extends Controller
{
    ...
    protected static function prepareResponse(array $result): JsonResponse
    {
        ...
        if (isset($result['data'])) {
            ...
            return response()->json(['message' => 'nothing to do'])->setStatusCode(401);
        }
    }
    ...
    protected static function taskingResponse(array $result): JsonResponse
    {
        if (isset($result["Location"])) {
            $location = ['Location' => $result["Location"]];
        } else {
